...
pacman::p_load("ggplot2", "viridis", "grid", "gridExtra", "lme4", "lmerTest", "emmeans","vegan", "devtools", "sjPlot", "here", "ape",
               "ggordiplots", "BiodiversityR", "dplyr", "tidyr", "DHARMa")
...
str (unrarefied_ASV_table) #2441 obs. of 43 variables
...
# Samples with lowest reads: WAF3 (7443), WAM6 (221)
...
physeq_nc #identified 6 contaminants and removed them leaving 2323 taxa

# Remove negative controls (n=4)

# Removing the Blanks
physeq2 <- subset_samples(physeq_nc, sample_or_control == "true_sample") 
physeq2 #39 samples, 2323 taxa
...
otu<-as(otu_table(physeq2),"matrix")
otu_biom<-make_biom(data=otu)
write_biom(otu_biom,"otu_biom_postfiltering.biom")
# '1.30.0' is just the version of the "bioformat" package installed in R

##### RAREFY READS TO MIN SAMPLING DEPTH ######

# Look at lowest sample depth
sample_sums(physeq2) # lowest sample depth: WAM6 (with 201 reads)
...
# 243 ASVs removed after subsampling- leaves 2080 taxa across 37 samples
physeqRare
...
head(physeqRareMeta)
str(physeqRareMeta) #37 samples

write.csv(physeqRareMeta, "metadata_jacana_micro.csv")
...
##### Alpha diversity Spearman correlations - data for Figure 1 ##### 

# Split by sex and species

alphaData_males <-subset(alphaData,sex=="male") 

alphaData_males_WA <-subset(alphaData_males,species=="J. jacana") 

alphaData_males_NO <-subset(alphaData_males,species=="J. spinosa") 

alphaData_females <-subset(alphaData,sex=="female") 

alphaData_females_WA <-subset(alphaData_females,species=="J. jacana") 

alphaData_females_NO <-subset(alphaData_females,species=="J. spinosa") 

##### Testosterone Spearman Correlations #####
##### Spearman - Testosterone X Faith PD - Male NO

spearman_T_faithpd_male_NO = cor.test(alphaData_males_NO$testosterone, alphaData_males_NO$FaithPD, method = "spearman")
print(spearman_T_faithpd_male_NO)

##### Spearman - Testosterone X Shannon - Male NO

spearman_T_shannon_male_NO = cor.test(alphaData_males_NO$testosterone, alphaData_males_NO$Shannon, method = "spearman", data = alphaData_males_NO)
print(spearman_T_shannon_male_NO)
write.csv(spearman_T_shannon_male_NO, 'spearman_T_shannon_male_NO.csv', row.names = FALSE)

##### Spearman - Testosterone X Chao1 - Male NO

spearman_T_chao1_male_NO = cor.test(alphaData_males_NO$testosterone, alphaData_males_NO$Chao1, method = "spearman", data = alphaData_males_NO)
print(spearman_T_chao1_male_NO)

##### Spearman - Testosterone X Faith PD - Female NO

spearman_T_faithpd_female_NO = cor.test(alphaData_females_NO$testosterone, alphaData_females_NO$FaithPD, method = "spearman")
print(spearman_T_faithpd_female_NO)

##### Spearman - Testosterone X Shannon - Female NO

spearman_T_shannon_female_NO = cor.test(alphaData_females_NO$testosterone, alphaData_females_NO$Shannon, method = "spearman")
print(spearman_T_shannon_female_NO)
write.csv(spearman_T_shannon_female_NO, 'spearman_T_shannon_female_NO.csv', row.names = FALSE)

##### Spearman - Testosterone X Chao1 - Female NO

spearman_T_chao1_female_NO = cor.test(alphaData_females_NO$testosterone, alphaData_females_NO$Chao1, method = "spearman")
print(spearman_T_chao1_female_NO)

##### Spearman - Testosterone X Faith PD - Male WA

spearman_T_faithpd_male_WA = cor.test(alphaData_males_WA$testosterone, alphaData_males_WA$FaithPD, method = "spearman")
print(spearman_T_faithpd_male_WA)

##### Spearman - Testosterone X Shannon - Male WA

spearman_T_shannon_male_WA = cor.test(alphaData_males_WA$testosterone, alphaData_males_WA$Shannon, method = "spearman")
print(spearman_T_shannon_male_WA)

##### Spearman - Testosterone X Chao1 - Male WA

spearman_T_chao1_male_WA = cor.test(alphaData_males_WA$testosterone, alphaData_males_WA$Chao1, method = "spearman")
print(spearman_T_chao1_male_WA)

##### Spearman - Testosterone X Faith PD - Female WA

spearman_T_faithpd_female_WA = cor.test(alphaData_females_WA$testosterone, alphaData_females_WA$FaithPD, method = "spearman")
print(spearman_T_faithpd_female_WA)

##### Spearman - Testosterone X Shannon - Female WA

spearman_T_shannon_female_WA = cor.test(alphaData_females_WA$testosterone, alphaData_females_WA$Shannon, method = "spearman")
print(spearman_T_shannon_female_WA)

##### Spearman - Testosterone X Chao1 - Female WA

spearman_T_chao1_female_WA = cor.test(alphaData_females_WA$testosterone, alphaData_females_WA$Chao1, method = "spearman")
print(spearman_T_chao1_female_WA)

##### Wingspur Spearman Correlations #####
##### Spearman - Wingspur X Faith PD - Male NO

spearman_spur_faithpd_male_NO = cor.test(alphaData_males_NO$avg_spur, alphaData_males_NO$FaithPD, method = "spearman")
print(spearman_spur_faithpd_male_NO)

##### Spearman - Wingspur X Shannon - Male NO

spearman_spur_shannon_male_NO = cor.test(alphaData_males_NO$avg_spur, alphaData_males_NO$Shannon, method = "spearman")
print(spearman_spur_shannon_male_NO)

##### Spearman - Wingspur X Chao1 - Male NO

spearman_spur_chao1_male_NO = cor.test(alphaData_males_NO$avg_spur, alphaData_males_NO$Chao1, method = "spearman")
print(spearman_spur_chao1_male_NO)

##### Spearman - Wingspur X Faith PD - Female NO

spearman_spur_faithpd_female_NO = cor.test(alphaData_females_NO$avg_spur, alphaData_females_NO$FaithPD, method = "spearman")
print(spearman_spur_faithpd_female_NO)

##### Spearman - Wingspur X Shannon - Female NO

spearman_spur_shannon_female_NO = cor.test(alphaData_females_NO$avg_spur, alphaData_females_NO$Shannon, method = "spearman")
print(spearman_spur_shannon_female_NO)

##### Spearman - Wingspur X Chao1 - Female NO

spearman_spur_chao1_female_NO = cor.test(alphaData_females_NO$avg_spur, alphaData_females_NO$Chao1, method = "spearman")
print(spearman_spur_chao1_female_NO)

##### Spearman - Wingspur X Faith PD - Male WA

spearman_spur_faithpd_male_WA = cor.test(alphaData_males_WA$avg_spur, alphaData_males_WA$FaithPD, method = "spearman")
print(spearman_spur_faithpd_male_WA)

##### Spearman - Wingspur X Shannon - Male WA

spearman_spur_shannon_male_WA = cor.test(alphaData_males_WA$avg_spur, alphaData_males_WA$Shannon, method = "spearman")
print(spearman_spur_shannon_male_WA)

##### Spearman - Wingspur X Chao1 - Male WA

spearman_spur_chao1_male_WA = cor.test(alphaData_males_WA$avg_spur, alphaData_males_WA$Chao1, method = "spearman")
print(spearman_spur_chao1_male_WA)

##### Spearman - Wingspur X Faith PD - Female WA

spearman_spur_faithpd_female_WA = cor.test(alphaData_females_WA$avg_spur, alphaData_females_WA$FaithPD, method = "spearman")
print(spearman_spur_faithpd_female_WA)

##### Spearman - Wingspur X Shannon - Female WA

spearman_spur_shannon_female_WA = cor.test(alphaData_females_WA$avg_spur, alphaData_females_WA$Shannon, method = "spearman")
print(spearman_spur_shannon_female_WA)

##### Spearman - Wingspur X Chao1 - Female WA

spearman_spur_chao1_female_WA = cor.test(alphaData_females_WA$avg_spur, alphaData_females_WA$Chao1, method = "spearman")
print(spearman_spur_chao1_female_WA)

##### Body Mass Spearman Correlations #####
##### Spearman - Body Mass X Faith PD - Male NO

spearman_body_mass_faithpd_male_NO = cor.test(alphaData_males_NO$body_mass, alphaData_males_NO$FaithPD, method = "spearman")
print(spearman_body_mass_faithpd_male_NO)

##### Spearman - Body Mass X Shannon - Male NO

spearman_body_mass_shannon_male_NO = cor.test(alphaData_males_NO$body_mass, alphaData_males_NO$Shannon, method = "spearman")
print(spearman_body_mass_shannon_male_NO)

##### Spearman - Body Mass X Chao1 - Male NO

spearman_body_mass_chao1_male_NO = cor.test(alphaData_males_NO$body_mass, alphaData_males_NO$Chao1, method = "spearman")
print(spearman_body_mass_chao1_male_NO)

##### Spearman - Body Mass X Faith PD - Female NO

spearman_body_mass_faithpd_female_NO = cor.test(alphaData_females_NO$body_mass, alphaData_females_NO$FaithPD, method = "spearman")
print(spearman_body_mass_faithpd_female_NO)

##### Spearman - Body Mass X Shannon - Female NO

spearman_body_mass_shannon_female_NO = cor.test(alphaData_females_NO$body_mass, alphaData_females_NO$Shannon, method = "spearman")
print(spearman_body_mass_shannon_female_NO)

##### Spearman - Body Mass X Chao1 - Female NO

spearman_body_mass_chao1_female_NO = cor.test(alphaData_females_NO$body_mass, alphaData_females_NO$Chao1, method = "spearman")
print(spearman_body_mass_chao1_female_NO)

##### Spearman - Body Mass X Faith PD - Male WA

spearman_body_mass_faithpd_male_WA = cor.test(alphaData_males_WA$body_mass, alphaData_males_WA$FaithPD, method = "spearman")
print(spearman_body_mass_faithpd_male_WA)

##### Spearman - Body Mass X Shannon - Male WA

spearman_body_mass_shannon_male_WA = cor.test(alphaData_males_WA$body_mass, alphaData_males_WA$Shannon, method = "spearman")
print(spearman_body_mass_shannon_male_WA)

##### Spearman - Body Mass X Chao1 - Male WA

spearman_body_mass_chao1_male_WA = cor.test(alphaData_males_WA$body_mass, alphaData_males_WA$Chao1, method = "spearman")
print(spearman_body_mass_chao1_male_WA)

##### Spearman - Body Mass X Faith PD - Female WA

spearman_body_mass_faithpd_female_WA = cor.test(alphaData_females_WA$body_mass, alphaData_females_WA$FaithPD, method = "spearman")
print(spearman_body_mass_faithpd_female_WA)

##### Spearman - Body Mass X Shannon - Female WA

spearman_body_mass_shannon_female_WA = cor.test(alphaData_females_WA$body_mass, alphaData_females_WA$Shannon, method = "spearman")
print(spearman_body_mass_shannon_female_WA)

##### Spearman - Body Mass X Chao1 - Female WA

spearman_body_mass_chao1_female_WA = cor.test(alphaData_females_WA$body_mass, alphaData_females_WA$Chao1, method = "spearman")
print(spearman_body_mass_chao1_female_WA)
...
str(KeepTaxa1_rare) #353 taxa

physeqBeta_rare<- prune_taxa(KeepTaxa1_rare,physeqRare)
physeqBeta_rare #353 taxa

##### Export rarefied ASV table and taxonomy into qiime2 for taxabarplot Figure #####
...
ordu = ordinate(physeqBeta_rare, "PCoA", "bray", weighted=FALSE)
P <- plot_ordination(physeqBeta_rare, ordu, color="sex", shape="species")
pca_sex_species_bray <- P + geom_point(alpha=0.5) + #alpha controls transparency and helps when points are overlapping
  theme_bw() +
  theme(text = element_text(size = 14), panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_shape_manual(values=c(16, 17), labels = c("J. jacana", "J. spinosa"), name = "Species") +
  scale_color_manual(values=c('darksalmon', 'dodgerblue4'), labels = c("Female", "Male"), name = "Sex")
...
ordu = ordinate(physeqBeta_rare, "PCoA", "jaccard", weighted=FALSE)
P <- plot_ordination(physeqBeta_rare, ordu, color="sex", shape="species")
pca_sex_species_jaccard <- P + geom_point(alpha=0.5) + #alpha controls transparency and helps when points are overlapping
  theme_bw() +
  theme(text = element_text(size = 14), panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_shape_manual(values=c(16, 17), labels = c("J. jacana", "J. spinosa"), name = "Species") +
  scale_color_manual(values=c('darksalmon', 'dodgerblue4'), labels = c("Female", "Male"), name = "Sex")
...
# Run Maaslin2 to correlate bacteria relative abundance with testosterone levels in female northern jacanas
# Output table gives ASV random letter/number codes found in ASV table
# Need to match ASV codes to taxonomy assignments
mas_1 <- Maaslin2(
  input_data = data.frame(otu_table(NO_female_physeqBeta_rare)),
  input_metadata = data.frame(sample_data(NO_female_physeqBeta_rare)),
  output = "./Maaslin2_female_northern_jacana_analysis",
  min_abundance = 0.0,
  min_prevalence = 0.0,
  normalization = "TSS",
  transform = "AST",
