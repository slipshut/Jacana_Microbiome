...
ggplot(northern.female, aes(x=testosterone, y=avg_spur)) + geom_point( color="#69b3a2")
...
ggplot(northern.female, aes(x=testosterone, y=Chao1)) + geom_point( color="#69b3a2")
...
ggplot(northern.female, aes(x=testosterone, y=FaithPD)) + geom_point( color="#69b3a2")
...
ggplot(northern.male, aes(x=body_mass, y=Shannon)) + geom_point( color="#69b3a2")
