...
# Maaslin2 heatmap figure

significant_results_heatmap <- read.csv("significant_results_heatmap.csv", header=TRUE, sep = ',')

ggplot(significant_results_heatmap, aes(x=Metadata, y=Genus, fill=coef)) +  # Map variables to aesthetics
